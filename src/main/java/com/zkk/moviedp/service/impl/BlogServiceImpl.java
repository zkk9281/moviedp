...
import com.zkk.moviedp.dto.ScrollResult;
...
import static com.zkk.moviedp.constants.RedisConstants.BLOG_LIKED_KEY;
import static com.zkk.moviedp.constants.RedisConstants.FEED_KEY;
...
public class BlogServiceImpl extends ServiceImpl<BlogMapper, Blog> implements IBlogService {
    ...
    public Result queryBlogLikes(Long id) {
        ...
        // 3.根据用户id查询用户 WHERE id IN ( 5 , 1 ) ORDER BY FIELD(id, 5, 1); 如果不排序，mysql默认按id升序返回
